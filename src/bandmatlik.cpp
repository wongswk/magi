...
extern "C" {
  ...
  void bmatvecmult(double *a, double *b, int *bandsize, int *matdim, double *result) {
    ...
    F77_CALL(dgbmv)("n", matdim, matdim, bandsize, bandsize, &one, a, &nrow, b, &ione, &zero, result,
             &ione);
  ...
  void bmatvecmultT(double *a, double *b, int *bandsize, int *matdim, double *result) {
    ...
    F77_CALL(dgbmv)("t", matdim, matdim, bandsize, bandsize, &one, a, &nrow, b, &ione, &zero, result,
             &ione);
