...
mkdir src/rcppgpds
rsync -az ../cmagi/*.cpp src/rcppgpds/
rsync -az ../cmagi/*.h src/rcppgpds/
...
LIB_PYGPDS_SOURCE=$(cd "$PROJECT"/cmagi && ls -- *.cpp)
LIB_PYGPDS_HEADERS=$(cd "$PROJECT"/cmagi && ls -- *.h)
cd "$PROJECT"/rmagi/src && rm $LIB_PYGPDS_SOURCE $LIB_PYGPDS_HEADERS
