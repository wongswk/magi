...
RUN apt-get update && DEBIAN_FRONTEND="noninteractive" apt-get install gcc-6 g++-6 python3-tk python3-pip python3-venv python3-dev ipython3 libblas-dev liblapack-dev gfortran git wget software-properties-common libxml2-dev build-essential libssl-dev libcurl4-openssl-dev -y
