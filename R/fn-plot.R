...
legend("center", c("truth", "median of all reconstructed trajectories", "95% interval from the 2.5 and 97.5 \n percentile of all reconstructed trajectories"), lty=c(1,1,0), lwd=c(4,3,0),
       col = c("red", "black", NA), fill=c(0, 0, "grey80"), pch=c(NA, NA, 15), x.intersp=c(2.5,2.5,0),
       border=c(0, 0, "grey80"), bty = "n", cex=1.8)
text(0.1, 0.9, "Ours", cex=2, pos=4)
dev.off()
...
legend("center", c("truth", "median of all reconstructed trajectories", "95% interval from the 2.5 and 97.5 \n percentile of all reconstructed trajectories"), lty=c(1,1,0), lwd=c(4,3,0),
       col = c("red", "black", NA), fill=c(0, 0, "grey80"), pch=c(NA, NA, 15), x.intersp=c(2.5,2.5,0),
       border=c(0, 0, "grey80"), bty = "n", cex=1.8)
text(0.1, 0.9, "Dondelinger", cex=2, pos=4)
...
par(mar=rep(0,4))
plot(c(0,1), c(0,1) ,type='n', xaxt='n', yaxt='n', xlab=NA, ylab=NA, frame.plot = FALSE)
legend("center", c("truth", "median of all inferred trajectories", "95% interval from the 2.5 and 97.5 \n percentile of all inferred trajectories"), lty=c(1,1,0), lwd=c(4,3,0),
