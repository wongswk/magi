...
load(paste0(rdaDir, "/variablephi-cool-0p33-warmstart/hes1log_summary.rda"), envir = env_all$warmstart)

subdirs <- c("../results/for_paper/7param//variablephi-cool-0p33-warmstart-updatephi/")

updateDir <- "../results/for_paper/7param//variablephi-cool-0p33-warmstart-updatephi/"
