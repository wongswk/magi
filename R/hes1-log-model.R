...
gpds:::plotPostSamplesFlex(
  paste0(outDir, config$kernel,"-",config$seed,"-",date(),"-hes1-log-fully-observed-trueSigma-phase2.pdf"), 
  xtrue, dotxtrue, xsim, gpode, pram.true, configWithPhiSig, odemodel)
...
saveRDS(absCI, paste0(
  outDir,
  config$loglikflag,"-hes1-log-fully-observed-trueSigma-phase2-",config$kernel,"-",config$seed,".rds"))
save.image(paste0(
  outDir,
  config$loglikflag,"-hes1-log-fully-observed-trueSigma-phase2-",config$kernel,"-",config$seed,".rda"))

pdf(paste0(outDir, config$kernel,"-",config$seed,"-",date(),"-hes1-log-fully-observed-trueSigma-phase2-addon.pdf"), 
    width = 8, height = 8)
