...
subdirs <- c("../results/for_paper/7param/variablephi-heating/")
...
dir.create("../results/for_paper/7param/variablephi-heating-updatephi", showWarnings = FALSE)

if (file.exists(paste0("../results/for_paper/7param/variablephi-heating-updatephi/Hes1-log-",
                       each_seed,"-7param-variablephi-heating-updatephi.rda"))){
  quit(save = "no")
}

load(paste0("../results/for_paper/7param/variablephi-heating/Hes1-log-",each_seed,"-7param-variablephi-heating.rda"))

# heating with (3, 3, 1) temperature with phi update ------------------------------------
#' there are 99 sampled X's (3 x 33) and only 33 actual observations.  
#' Using the logic about cooling, the default temperatures for Hes1 should be (3, 3, 1).
...
outDir <- "../results/for_paper/7param/variablephi-heating-updatephi/"
...
gpds:::plotPostSamplesFlex(
  paste0(outDir, config$modelName,"-",config$seed,"-7param-variablephi-heating-updatephi.pdf"), 
  xtrue, dotxtrue, xsim, gpode, pram.true, config, odemodel)

save.image(paste0(outDir, config$modelName,"-",config$seed,"-7param-variablephi-heating-updatephi.rda"))
