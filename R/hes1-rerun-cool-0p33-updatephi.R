...
dir.create("../results/for_paper/7param/variablephi-cool-0p33-warmstart-updatephi", showWarnings = FALSE)

if (file.exists(paste0("../results/for_paper/7param/variablephi-cool-0p33-warmstart-updatephi/Hes1-log-",
                       each_seed,"-7param-variablephi-cool-0p33-warmstart-updatephi.rda"))){
  quit(save = "no")
}
...
outDir <- "../results/for_paper/7param/variablephi-cool-0p33-warmstart-updatephi/"
...
gpds:::plotPostSamplesFlex(
  paste0(outDir, config$modelName,"-",config$seed,"-7param-variablephi-cool-0p33-warmstart-updatephi.pdf"), 
  xtrue, dotxtrue, xsim, gpode, pram.true, config, odemodel)

save.image(paste0(outDir, config$modelName,"-",config$seed,"-7param-variablephi-cool-0p33-warmstart-updatephi.rda"))
