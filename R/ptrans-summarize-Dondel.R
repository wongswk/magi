...
save(Dondel, DondelPostX, file=paste0(outDirWenk,"Dondel.rda"))
...
rmse.table <- round(apply(sapply(Dondel, function(x) x$rmseOdePM), 1, mean), digits=4)
...
oursPostX <- simplify2array(DondelPostX)
