...
# GP init X; (4, 4, 1) temperature ----------------------------
# outDir <- "../results/fn-temper/gpX-temperature441/"
# dir.create(outDir, showWarnings = FALSE, recursive = TRUE)
# config$priorTemperature <- config$ndis / config$nobs  
# config$priorTemperatureObs <- 1
# 
...
# linear interpolation X; (4, 4, 1) temperature ----------------------------
outDir <- "../results/fn-temper/liX-temperature441/"
dir.create(outDir, showWarnings = FALSE, recursive = TRUE)
config$priorTemperature <- config$ndis / config$nobs  
config$priorTemperatureObs <- 1
...
# # linear interpolation X; (1, 1, 1) temperature ----------------------------
# outDir <- "../results/fn-temper/liX-temperature111/"
# dir.create(outDir, showWarnings = FALSE, recursive = TRUE)
# config$priorTemperature <- 1
# config$priorTemperatureObs <- 1
# 
...
# save(xtrue, dotxtrue, xsim, gpode, pram.true, config, odemodel, OursTimeUsed, file= paste0(outDir, config$modelName,"-",config$seed,"-noise", config$noise[1], ".rda"))
# 
# # linear interpolation X; (1, 1, 1/4) temperature ----------------------------
# outDir <- "../results/fn-temper/liX-temperature111o4/"
# dir.create(outDir, showWarnings = FALSE, recursive = TRUE)
# config$priorTemperature <- 1
