...
summary(FNres0, sigma = TRUE, par.names = FNpar.names)
summary(FNres1, sigma = TRUE, par.names = FNpar.names)
summary(FNres2, sigma = TRUE, par.names = FNpar.names)
summary(FNres3, sigma = TRUE, par.names = FNpar.names)
