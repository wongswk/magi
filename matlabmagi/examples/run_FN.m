...
[samplesCpp, phiUsed] = solveMagi( xsim(:,2:size(xsim,2)), fnmodel, xsim(:,1)', [], [], xInit, [], [], [], config.priorTemperature, config.priorTemperature, 1, char(config.kernel), config.hmcSteps, config.burninRatio, config.n_iter, ...
