...
outFileName =  sprintf('result-%s-noise%.3f-linspace%.2f-useExoSigma%d-useFixedSigma%d-linearizeInit%d-useBand%d-bandsize%d', config.modelName, config.noise(1), config.linfillspace, config.useExoSigma, config.useFixedSigma, config.linearizexInit, config.useBand, config.bandsize);
